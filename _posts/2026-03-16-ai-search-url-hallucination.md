...
<li>
<b>URL:</b> The acronym URL is short for [Uniform Resource Locator](https://en.wikipedia.org/wiki/URL). It is the address of a resource (or simply a web page). Many times, links and URLs are used to refer to the same thing.
</li>
<li>
...
<div>
  <canvas id="statusCodeChart" style="max-height: 20rem;"></canvas>
</div>
